...
'''*****************************************************************************************************************
    Pi Remind 2023
    By Elliott Wills
    www.elliottjwills.com

    My google calender reminder linked to raspberry pi. 
    ...
    Remidner app example code: 'johnwargo.com'

    Updated 2023-03-12 - Updated and revamped to current libraries
